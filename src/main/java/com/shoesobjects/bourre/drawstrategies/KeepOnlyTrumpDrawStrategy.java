...
public class KeepOnlyTrumpDrawStrategy extends DrawStrategy {


    public BourreHand removeDiscards(BourreHand hand, Card dealerTrumpCard, DrawPosition drawPosition) {
        super.removeDiscards(hand, dealerTrumpCard, drawPosition);

        holdAllTrumpCards(hand, dealerTrumpCard.getCardSuite());

        discardRemaining(hand);
        return hand;
    }

    public String toString() {
        return "KeepOnlyTrumpDrawStrategy";
    }
